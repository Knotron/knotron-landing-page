  ...
  return (
    <div className="space-y-8 bg-black py-24 md:py-32">
      <div className="flex flex-col items-center text-center space-y-4">
        <h1 className="text-3xl md:text-5xl font-arial text-[#f2f5f9]">
          Fully Autonomous Meetings
        </h1>
        <p className="text-lg md:text-2xl font-arial text-[#c1c3d0]">
          Get in, be present, and let AI take care of the rest
        </p>
      </div>
...
const items = [
  ...
  {
    title: 'Action Items',
    description: 'Get reminders for tasks mentioned in meetings',
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl">
        <img
          alt="M"
